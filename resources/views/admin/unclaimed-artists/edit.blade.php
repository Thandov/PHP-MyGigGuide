...
<div class="p-6">
    <div class="max-w-4xl mx-auto">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Edit Unclaimed Artist: {{ $artist->stage_name }}</h1>
            <p class="text-gray-600">Update artiytst information and details</p>
        </div>

        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form method="POST" action="{{ route('admin.unclaimed-artists.update', $artist) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="real_name" name="real_name" value="{{ old('real_name', $artist->real_name) }}"
                    ...
                    <div>
                        ...
                        <input type="email" id="contact_email" name="contact_email" value="{{ old('contact_email', $artist->contact_email) }}" required
                        ...
                        @error('contact_email')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Required for unclaimed artists</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" id="website" name="website" value="{{ old('website', $artist->website) }}"
                ...
                <div class="flex justify-end space-x-4 mt-8">
                    <a href="{{ route('admin.unclaimed-artists.index') }}" class="px-4 py-2 text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 transition-colors duration-200">
                        Cancel
                    </a>
