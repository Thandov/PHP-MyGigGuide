            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">
                        Welcome bdack, {{ $artist->stage_name ?? $artist->real_name }}!
                    </h1>
                    <p class="text-gray-600 mt-2">Manage your music career and upcoming performances</p>
                </div>
                <div class="flex space-x-3">
                    <a href="{{ route('artists.edit', $artist->id) }}" class="btn-secondary">
                    ...
                    <form action="{{ route('features.checkout') }}" method="GET">
                        ...
                        <button class="btn-primary ml-2" type="submit">Boost Profile</button>
                    </form>
                    @endauth
                </div>
            </div>
